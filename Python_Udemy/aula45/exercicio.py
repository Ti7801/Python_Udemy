...
-> Crie uma função que encontra o primeiro número duplicado.Considerando
o segundo número como a duplicação. Retorne a duplicação considerada
        requisitos:
            A ordem do número duplicado é considera a partir da segunda
            ocorrência do número, ou seja, o número duplicado em si.
            (o número duplicado em si).
            Exemplo: (retornar o segundo duplicado)
